...
if __name__ == "__main__":
    backtestname = "RNCC" #pick up from \\runs\\portfolio_configs.csv
    ...
    run_backtest(backtestname, end_date, "btbuilder", data_library.tsx_holidays(), timestamp=dt.datetime.now(), optional_des=f"_10_20_OTM")